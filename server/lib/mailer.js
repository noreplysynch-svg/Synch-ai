...
export async function sendMagicLinkEmail(to, loginUrl) {
  await sendEmail({
    to,
    subject: 'Your Synch AI sign-in link',
    html: `<p>Click the link below to sign in. This link expires in 15 minutes and can only be used once.</p><p><a href="${loginUrl}">${loginUrl}</a></p><p>If you didn't request this, you can safely ignore this email.</p>`,
  });
}
